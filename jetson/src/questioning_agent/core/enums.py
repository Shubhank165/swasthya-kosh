...
else:  # pragma: no cover - the Jetson's system Python is 3.10
    # StrEnum arrived in 3.11 and the kiosk's offline venv is 3.10. `str, Enum` is what
    # StrEnum is: members compare equal to their value and format as it, which is all the
    # content loader and the YAML rules rely on.
