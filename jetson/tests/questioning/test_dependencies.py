...
from questioning_agent.core.schemas import Condition
from questioning_agent.questioning.candidate_generator import candidates
from questioning_agent.questioning.dependencies import Tri, evaluate
...
class TestCompression:
    ...
    def test_a_merged_question_outranks_the_specific_ones(
        ...
        from questioning_agent.questioning.scoring import score
...
class TestSafetyStopsEverything:
    ...
    def test_safety_is_not_in_the_scoring(self) -> None:
        ...
        from questioning_agent.questioning import scoring
